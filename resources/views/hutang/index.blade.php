...
<div class="container mt-5">  
    <h1 class="mb-4">Daftar Hutang</h1>  

    <!-- Form Pencarian dan Filter -->  
    <form action="{{ route('hutang.index') }}" method="GET" class="mb-3 d-flex align-items-center">  
        <input type="text" name="search" class="form-control me-2" placeholder="Cari Nama Supplier atau No Faktur..." value="{{ request('search') }}">  
        ...
        <a href="{{ route('hutang.index') }}" class="btn btn-secondary">Reset</a>  
    </form>  
